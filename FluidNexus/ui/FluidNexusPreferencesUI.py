...
class Ui_FluidNexusPreferences(object):
    def setupUi(self, FluidNexusPreferences):
        ...
        self.bluetoothCheckbox = QtGui.QCheckBox(self.formLayoutWidget)
        self.bluetoothCheckbox.setObjectName(_fromUtf8("bluetoothCheckbox"))
        self.networkFormLayout.setWidget(0, QtGui.QFormLayout.FieldRole, self.bluetoothCheckbox)
    ...
    def retranslateUi(self, FluidNexusPreferences):
        ...
        self.bluetoothCheckbox.setText(QtGui.QApplication.translate("FluidNexusPreferences", "Bluetooth", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.comboBox.setItemText(0, QtGui.QApplication.translate("FluidNexusPreferences", "5 seconds", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox.setItemText(1, QtGui.QApplication.translate("FluidNexusPreferences", "10 seconds", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox.setItemText(2, QtGui.QApplication.translate("FluidNexusPreferences", "30 seconds", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox.setItemText(3, QtGui.QApplication.translate("FluidNexusPreferences", "1 minute", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox.setItemText(4, QtGui.QApplication.translate("FluidNexusPreferences", "2 minutes", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox.setItemText(5, QtGui.QApplication.translate("FluidNexusPreferences", "5 minutes", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox.setItemText(6, QtGui.QApplication.translate("FluidNexusPreferences", "10 minutes", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox.setItemText(7, QtGui.QApplication.translate("FluidNexusPreferences", "20 minutes", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox.setItemText(8, QtGui.QApplication.translate("FluidNexusPreferences", "30 minutes", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox.setItemText(9, QtGui.QApplication.translate("FluidNexusPreferences", "1 hour", None, QtGui.QApplication.UnicodeUTF8))
